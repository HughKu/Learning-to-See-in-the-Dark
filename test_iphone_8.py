...
input_dir = './images/Iphone/8/short/'
gt_dir = './images/Iphone/8/long/'
checkpoint_dir = './checkpoint/Sony/'
result_dir = './result_iphone/8/'
...
def pack_raw(raw):
    ...
    im = np.maximum(im - 535, 0) / (16383 - 535)  # subtract the black level
...
for test_id in test_ids:
    ...
    for k in range(len(in_files)):
        ...
        ratio = 100 #min(gt_exposure / in_exposure, 300)
